function [stats, g, subTable] = shrGliavsNoGlia_CFR(biggestTable)
% shrGLIAVSNOGLIA - Compare shr neurons with vs without glia (controls
% only) - current at first nonzero response
    ...
    [stats, g, subTable] = blt.stats.anovaTool(subTable, ...
        ...
        'FigureTitle', "current at first nonzero response in shr Neurons: ± Glia (Controls)");
