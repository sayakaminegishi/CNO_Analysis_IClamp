function [P, TBL, STATS] = tableANOVA_SHR_NeuronalDREADDs_CNO_vs_NoCNO_NeuronsOnly_AllFitl(biggestTable)
% TABLEANOVA_SHR_NEURONALDREADDS_CNO_VS_NO_CNO_NEURONSONLY_ALLFITLESS_RANKED
% ANOVA on RANKS comparing:
%   SHR Neurons ONLY + Neuronal DREADDs + CNO  vs  SHR Neurons ONLY + Neuronal DREADDs only (No CNO)
%
...
% -------------------------------------------------------------------------
% 3) Apply Global Filters (SHR, NEURONS ONLY, WITH DREADDs/Virus)
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
figure('Name', 'SHR Neurons Only: DREADDs + CNO vs DREADDs only (Ranked)', ...
       'Units', 'normalized', 'Position', [0.05 0.05 0.9 0.85]);
t = tiledlayout(2, 3, 'TileSpacing', 'compact', 'Padding', 'compact');
title(t, 'SHR Neurons ONLY + Neuronal DREADDs: CNO vs No CNO (Rank-transformed ANOVA)', ...
...
text(0.05, 0.64, 'Strain = SHR', 'Interpreter', 'none');
