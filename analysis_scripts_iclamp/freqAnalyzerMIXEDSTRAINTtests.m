...
filename_Control = '/Users/sayakaminegishi/Documents/Birren Lab/2025/CNOdata_results/Jun6_Results/WKYNG_ONLY';
filename_Treated = '/Users/sayakaminegishi/Documents/Birren Lab/2025/CNOdata_results/Jan28_26_results/SHRNG_ONLY.xlsx'; %48h CNO

%%%%%% Load Data for WKY %%%%%%

% Read full tables
T_WKY_Control = readtable(filename_Control);
T_WKY_Treated = readtable(filename_Treated);
...
title(sprintf('Frequency vs Current Injection\n(n = %d Control, %d Treated)', n_Control, n_Treated));
