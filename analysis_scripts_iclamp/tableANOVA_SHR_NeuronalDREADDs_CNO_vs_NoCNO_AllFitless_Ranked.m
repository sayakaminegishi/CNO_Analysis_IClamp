function [P, TBL, STATS] = tableANOVA_SHR_NeuronalDREADDs_CNO_vs_NoCNO_AllFitless_Ranked(biggestTable)
% TABLEANOVA_SHR_NEURONALDREADDS_CNO_VS_NO_CNO_ALLFITLESS_RANKED
% ANOVA on RANKS comparing:
%   SHR Neurons+Glia + Neuronal DREADDs + CNO  vs  SHR Neurons+Glia + Neuronal DREADDs only (No CNO)
%
...
% -------------------------------------------------------------------------
% 3) Apply Global Filters (SHR, Neurons+Glia, WITH DREADDs/Virus)
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
figure('Name', 'SHR: Neuronal DREADDs + CNO vs DREADDs only (Ranked)', ...
       'Units', 'normalized', 'Position', [0.05 0.05 0.9 0.85]);
t = tiledlayout(2, 3, 'TileSpacing', 'compact', 'Padding', 'compact');
title(t, 'SHR Neurons+Glia + Neuronal DREADDs: CNO vs No CNO (Rank-transformed ANOVA)', ...
