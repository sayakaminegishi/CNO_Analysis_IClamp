%%%%%% t-test frequency analysis between SHR Treated and Control
...
filename_SHRControl = '/Users/sayakaminegishi/Documents/Birren Lab/2025/CNOdata_results/Jan28_26_results/SHRN_ONLY';
filename_SHRTreated = '/Users/sayakaminegishi/Documents/Birren Lab/2025/CNOdata_results/Jan28_26_results/SHRNG_ONLY.xlsx'; %48h CNO

%%%%%% Load Data for WKY %%%%%%

% Read full tables
T_WKY_Control = readtable(filename_SHRControl);
T_WKY_Treated = readtable(filename_SHRTreated);
...
title(sprintf('SHR: Frequency vs Current Injection\n(n = %d Control, %d Treated)', n_Control, n_Treated));
