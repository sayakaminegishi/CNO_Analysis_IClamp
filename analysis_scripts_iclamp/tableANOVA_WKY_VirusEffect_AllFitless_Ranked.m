function [P, TBL, STATS] = tableANOVA_WKY_VirusEffect_AllFitless_Ranked(biggestTable)
% TABLEANOVA_WKY_VIRUSEFFECT_FIXEDLABELS - ANOVA on RANKS comparing Virus vs No Virus
...
% -------------------------------------------------------------------------
figure('Name', 'WKY: Virus Presence Comparison (Ranked)', ...
       'Units', 'normalized', 'Position', [0.05 0.05 0.9 0.85]);
t = tiledlayout(2, 3, 'TileSpacing', 'compact', 'Padding', 'compact');
title(t, 'WKY Neurons + Glia + DREADDS, No CNO (Rank-transformed ANOVA)', ...
...
nexttile(6); axis off;
text(0.05, 0.5, 'Filter: WKY, Neurons+Glia, Control Only (Ranked)', 'FontWeight', 'bold');
