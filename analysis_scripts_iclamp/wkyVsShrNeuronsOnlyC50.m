function [stats, g, subTable] = wkyVsShrNeuronsOnlyC50(biggestTable)
...
%   - ANALYZES: C50 (Dependent) vs. Strain Name (Factor).
    ...
    Factors = "StrainName";
    Measurement = "FIcalc.fitless.interpolated_c50";

    % 3. Execution
    [stats, g, subTable] = blt.stats.anovaTool(biggestTable, ...
        Measurement, Selection, Factors, ...
        'FigureTitle', "Analysis: C50 by Strain (Neurons Only Controls)");
