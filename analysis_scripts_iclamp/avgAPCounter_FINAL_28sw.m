...
ungroupedTableName='WKYNDG_acuteCNO_UNGROUPED.xlsx'; %name of summary excel table with AP counts that includes all the trials from each cell(i.e. not averaged)
