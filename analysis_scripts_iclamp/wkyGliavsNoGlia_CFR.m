function [stats, g, subTable] = wkyGliavsNoGlia_CFR(biggestTable)
% WKYGLIAVSNOGLIA - Compare WKY neurons with vs without glia (controls
% only) - current at first response
    ...
    [stats, g, subTable] = blt.stats.anovaTool(subTable, ...
        ...
        'FigureTitle', "Current at first nonzero response in WKY Neurons: ± Glia (Controls)");
